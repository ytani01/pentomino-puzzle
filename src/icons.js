/**
 * HUD のボタンのアイコン（TODO-042）と、タイトルのボード・色の選択肢の図（TODO-046）。
 *
...
/**
 * タイトルで選ぶボードの形（TODO-046）。「8×8」の文字より、穴のある正方形と横長の
 * 長方形を見せたほうが一目で分かる。マスは選択の状態で変わる色（`color`）で塗り、
 * 選んだボードが文字と同じく強調色になるようにする。
 */
 ...
 * 塗り・マスの区切り・外周の色と太さは、ボードのマス目（`boot.js`）とピースの
