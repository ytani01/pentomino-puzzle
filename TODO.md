...
**残っている項目: TODO-061〜065・067。** これまでに 61 件を決着させた。
新しく足すときは「完了済み」の上に節を作る。
**新規項目の番号は `TODO-068` から。**

着手する順番の案（TODO-061〜065・067）: 062 → 067 → 061 → 063 → 064 → 065
...
- 067 は 060・066 と同じ「置いた直後に外す」の延長で決めることが無いので、062 の次にする
