...
**残っている項目: TODO-061・063〜065・067・068。** これまでに 62 件を決着させた。
新しく足すときは「完了済み」の上に節を作る。
**新規項目の番号は `TODO-069` から。**

着手する順番の案（TODO-061・063〜065・067・068）: 067 → 068 → 061 → 063 → 064 → 065

- 063 は 060〜062 のあとにする。置き方が変わると詰まり方も変わるため
- 064 と 065 は探索を変えない見せ方なので最後にする。065 の回す時間は
  064 の待ち時間と重なるので、064 を先にする
- 067・068 は 060・066 と同じ「置いた直後に外す」の延長で決めることが無いので、最初にする
